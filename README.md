...
```
© Credits
Modified Baileys @TuanVinn7
```

# WhatsApp Baileys

<p align="center">
  <img src="https://tuanvinn-storage.vercel.app/image/TuanVinn-Profile.jpg" alt="Thumbnail" />
</p>
...
```javascript
await TuanVinn.sendMessage(groupId, {
orderMessage: {
orderId: "7778",
...
```javascript
await TuanVinn.sendMessage(m.chat, {
nativeFlowMessage: {
buttons: [
{
name: "review_and_pay",
...
joinLink: "https://call.whatsapp.com/video/TuanVinn7",
...
canonical_url: "https://t.me/TuanVinn7",
...
mediaUrl: " X ",
sourceUrl: "https://t.me/TuanVinn7",
...
url: "https://t.me/TuanVinn7",
merchant_url: "https://t.me/TuanVinn7"
})
}
]
}
...
## Mengapa Memilih TuanVinn Baileys?
...
─╚╗╔╝║║║║║║║║
──╚╝─╚╩╝╚╩╝╚╝
Terimakasih Sudah Menggunakan Baileys Kami
WhatsApp: 6285172360191
WhatsApp Channel: https://whatsapp.com/channel/0029Vb6hSZ6I7BeAAjsLxh3F
Telegram: @TuanVinn7
Telegram Channel: @TuanVinnProject
